...
const fallbackApiBase = "https://nairobi-local-picks-demo.hantianyang5.chatgpt.site";
...
const usesWebDevProxy = __DEV__ && Platform.OS === "web" && !process.env.EXPO_PUBLIC_API_BASE_URL;

export const API_BASE_URL = (
  usesWebDevProxy ? webDevProxyBase : process.env.EXPO_PUBLIC_API_BASE_URL || fallbackApiBase
).replace(/\/$/, "");
