...
const styles = StyleSheet.create({
  ...
  heart: { color: colors.clay, fontSize: 26 },
  ...
  tabTextActive: { color: colors.clay, fontWeight: "900" },
  tabIndicator: {
    width: 20,
    height: 3,
    borderRadius: 2,
  ...
  placeholderLetter: { color: colors.clay, fontSize: 72, fontWeight: "900" },
  ...
  verifiedBadgeText: { color: colors.moss, fontSize: 11, fontWeight: "900" },
  ...
  contactChipText: { color: colors.clay, fontSize: 14, fontWeight: "800" },
  notice: {
  ...
  directoryActionIcon: { color: colors.clay, fontSize: 20 },
  directoryActionText: { color: colors.clay, fontSize: 16, fontWeight: "800" },
  ...
  stickyBookPrice: { color: colors.moss, fontSize: 14, fontWeight: "600", marginTop: 2 },
  stickyBookBtn: {
    backgroundColor: colors.clay,
